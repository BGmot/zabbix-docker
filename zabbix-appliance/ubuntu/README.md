...
This repository is a fork of https://github.com/zabbix/zabbix-docker.git with only purpose being to build Docker images of Zabbix appliance to test code from this repository https://github.com/BGmot/zabbix.git. Please read [README-bg](https://github.com/BGmot/zabbix/blob/5.2.2-bg/README-bg.md) for details.
...
These repo provides an UNOFFICIAL Zabbix appliance Docker images. They are based on Ubuntu 20.04 (focal) image. The available versions of Zabbix appliance are:
    ...
    Zabbix appliance 5.2.* (tags: ubuntu-5.2.*)
