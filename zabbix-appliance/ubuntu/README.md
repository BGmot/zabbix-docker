...
This repository is a fork of https://github.com/zabbix/zabbix-docker.git with only purpose being to build Docker images of Zabbix appliance to test code from this repository https://github.com/BGmot/zabbix.git. Please read [README-bg](https://github.com/BGmot/zabbix/blob/5.0.3-bg/README-bg.md) for details.

All development activities in this Repository happen in 5.X-bg branches.
...
These repo provides an UNOFFICIAL Zabbix appliance Docker images. They are based on Ubuntu 20.04 (focal) image. The available versions of Zabbix appliance are:

    Zabbix appliance 5.0.* (tags: ubuntu-5.0.*)
...
Start a Zabbix server container as follows:
    ...
    docker run --name some-zabbix-appliance -p 80:80 -p 10051:10051 -d bgmot42/zabbix-appliance-ubuntu:tagname

Where `some-zabbix-appliance` is the name you want to assign to your container. See the list above for relevant tags, or look at the [full list of tags](https://hub.docker.com/repository/docker/bgmot42/zabbix-appliance-ubuntu/tags/).
...
Documentation for this image is stored in the [`zabbix-appliance/` directory](https://github.com/BGmot/zabbix-docker/tree/5.0-bg/zabbix-appliance/ubuntu) of the [`zabbix/zabbix-docker` GitHub repo](https://github.com/BGmot/zabbix-docker/). Be sure to familiarize yourself with the [repository's `README.md` file](https://github.com/BGmot/zabbix-docker/blob/5.0-bg/README.md) before attempting a pull request.

## Issues

If you have any problems with or questions about this image, please contact us through a [GitHub issue](https://github.com/BGmot/zabbix-docker/issues).
